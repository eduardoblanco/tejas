...
def read_corpus(annotations_file, max_insts=-1):
    ...
    for _, annotation in annotations.iterrows():
        ...
        if annotation['Wiki_title'] not in article_titles:
            article_titles[annotation['Wiki_title']] = nlp(unicode(annotation['Wiki_title'], 'utf-8'))
        if annotation['Section_title'] not in section_titles:
            section_titles[annotation['Section_title']] = nlp(unicode(annotation['Section_title'], 'utf-8'))
        if annotation['Section_contents'] not in section_contents:
            section_contents[annotation['Section_contents']] = nlp(unicode(annotation['Section_contents'], 'utf-8'))
        ...
        possessor_text = unicode(str(annotation['Possessor']), 'utf-8')
